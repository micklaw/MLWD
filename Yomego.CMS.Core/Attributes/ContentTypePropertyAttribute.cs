...
namespace Yomego.CMS.Core.Attributes
{
    ...
    public class ContentTypePropertyAttribute : Attribute
    {
        public ContentTypePropertyAttribute() 
        {
        ...
        public ContentTypePropertyAttribute(ContentTypePropertyUI type) : this()
        {
            this.Type = type;
        ...
        /// </summary>
        public ContentTypePropertyUI? Type { get; private set; }
