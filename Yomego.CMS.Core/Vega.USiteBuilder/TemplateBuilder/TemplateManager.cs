...
namespace Vega.USiteBuilder.TemplateBuilder
{
    internal class TemplateManager : ManagerBase
    {
        ...
        {
            if (Util.DefaultRenderingEngine == global::Umbraco.Core.RenderingEngine.WebForms)
            {
        ...
        {
            string viewsPath = System.Web.Hosting.HostingEnvironment.MapPath(global::Umbraco.Core.IO.SystemDirectories.MvcViews);
            if (viewsPath != null)
            {
