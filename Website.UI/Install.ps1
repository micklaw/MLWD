...
$robots = $handlers.SelectSingleNode("add[@name='Robots-ISAPI-Integrated-4.0']")
$sitemap = $handlers.SelectSingleNode("add[@name='Sitemap-ISAPI-Integrated-4.0']")
...
$section = $xml.SelectSingleNode("configuration/configSections/section[@name='cluster']")
...
$cluster = $xml.SelectSingleNode("configuration/cluster")
...
$indexSet = $xmlEi.SelectSingleNode("ExamineLuceneIndexSets/IndexSet[@SetName='WebsiteIndexSet']")
...
$websiteIndexer = $xmlEs.SelectSingleNode("Examine/ExamineIndexProviders/providers/add[@name='WebsiteIndexer']")

if ($websiteIndexer -eq $null)
{
...
$key = $xmlEn.SelectSingleNode("language/area[@alias='sections']/key[@alias='Yomego']")
